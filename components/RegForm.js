          ...
          <div className="my-4">
            ...
            {fields.map((field, index) => {
              return (
                <>
                  <section
                    className="w-full border border-gray-200 p-2 rounded mb-3 bg-gray-100 shadow-md"
                    key={field.id}
                  >
                    <div className="my-4">
                      <label
                    ...
                    <div className="flex flex-col items-end">
                      <button
                        className="bg-red-500 text-white px-2 rounded-lg hover:bg-red-600 font-bold shadow-lg"
                        type="button"
            ...
            <section className="pt-3">
              <button
                className="bg-blue-500 text-white px-2 rounded-lg hover:bg-blue-600 font-bold shadow-lg"
                type="button"
                onClick={() => append({})}
              >
                <div className="flex">
            ...
            <div className="my-4 flex justify-center">
              <button
                className="w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 font-bold text-lg shadow-lg"
                type="submit"
              >
                Register!
              </button>
